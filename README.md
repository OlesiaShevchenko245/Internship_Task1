...
3. Обмеження CPU. На MacBook Air є всього 8–10 апаратних ядер, тому запуск 8 потоків для “легкої” задачі не збільшує продуктивність — ядра і так не завантажені.
4. XML-парсинг відносно дорогий, але не достатньо важкий. Парсинг займає основну частину часу, але одного файлу вистачає, щоб навантажити CPU лише частково. Щоб побачити різницю, потрібні десятки великих файлів (250–500 МБ кожен).
